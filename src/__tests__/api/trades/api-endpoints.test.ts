...
import {
  GET as GET_TRADES,
  POST as CREATE_TRADE,
} from '@/app/api/portfolios/[portfolioId]/trades/route';
import {
  PUT as UPDATE_TRADE,
  DELETE as DELETE_TRADE,
} from '@/app/api/trades/[id]/route';
...
describe('Trade API Endpoints', () => {
  ...
  describe('PUT /api/trades/[id] - Update Trade', () => {
    ...
    it('should update parent LONG when SHORT is closed', async () => {
      ...
      // Net received: 55,000 × 0.99 = 54,450 USD
