...
import { ITrade, TradeStatus, ExportFormat, ExportInclude } from '@/types';
...
function generateExcelFile(
  ...
  if (includePortfolioInfo) {
    const portfolioData = [
      ...
      ['Total Deposit', `$${totalDeposit.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`],
...
export async function GET(
  ...
  try {
    ...
    let tradesQuery: any = { portfolioId };
