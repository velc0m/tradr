...
import { PortfolioStatistics, IPortfolio } from '@/types';
import { ArrowLeft, TrendingUp, TrendingDown, Target, DollarSign, BarChart3, Trophy } from 'lucide-react';
import {
  LineChart,
  Line,
  XAxis,
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <div className="text-sm font-medium text-green-500">
                        {stats.bestTrade.trade.coinSymbol}: +${formatCurrency(stats.bestTrade.trade.profitUSD)}
                      </div>
                    </div>
                    {stats.worstTrade && (
                      <div>
                        <div className="text-xs text-muted-foreground">Worst</div>
                        <div className={`text-sm font-medium ${stats.worstTrade.trade.profitUSD >= 0 ? 'text-green-500' : 'text-red-500'}`}>
