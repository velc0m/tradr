                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p className="text-xs">
                                                    {showCurrentValue
                                                        ? "Общая прибыль/убыток по всем закрытым сделкам (LONG в USD + SHORT в USD по текущим ценам). Для SHORT используются приблизительные текущие цены."
                                                        : "Общая прибыль/убыток по всем закрытым сделкам. Включает только LONG позиции в USD. SHORT показывается отдельно в монетах."
                                                    }
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                ...
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p className="text-xs">
                                                    Процент прибыльных сделок от общего количества закрытых сделок.
                                                    Например, если из 10 сделок 7 были прибыльными, Win Rate = 70%
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                ...
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p className="text-xs">
                                                    Средняя прибыль/убыток за одну сделку. Рассчитывается как сумма всех
                                                    прибылей и убытков, делённая на количество закрытых сделок.
                                                    Показывает типичный результат одной сделки.
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                ...
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p className="text-xs">
                                                    Общая сумма комиссий (entry + exit fees), уплаченных на всех
                                                    закрытых сделках.
                                                    Разделена на Standard Trades (обычные LONG/SHORT) и Averaging
                                                    Operations (averaging shorts).
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xl font-bold">{formatPercent(stats.long.winRate)}%
                                            </div>
                                        </div>
                                        <div>
                            ...
                            {stats.short && stats.short.totalTrades > 0 && (
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div>
                                            <div className="text-sm text-muted-foreground">Win Rate</div>
                                            <div className="text-xl font-bold">{formatPercent(stats.short.winRate)}%
                                            </div>
                                        </div>
                                        <div>
                                            <div className="text-sm text-muted-foreground">Avg Profit per Trade</div>
