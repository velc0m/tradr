...
export function EditExitPriceModal({
    ...
    const [exitFee, setExitFee] = useState(trade.exitFee?.toString() || trade.entryFee?.toString() || '0.6');
    ...
    useEffect(() => {
        ...
        setExitFee(trade.exitFee?.toString() || trade.entryFee?.toString() || '0.6');
    }, [trade]);
    ...
    const fetchExitFee = async () => {
        try {
            console.log('Fetching exit fee for trade:', {
                tradeId: trade._id,
                isSplit: trade.isSplit,
                splitFromTradeId: trade.splitFromTradeId,
            ...
            console.log('Exit fee API response:', data);
